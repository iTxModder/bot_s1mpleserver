...
<:certo:580518832611786753> **|** Como é **👑 S1mple Nitro Classic** ganhou mais ${amount} moons!`)
    ...
    message.channel.send(`<a:economia:580518832792272916> **|** Você recebeu suas ${amount9} moons diarias.
<:certo:580518832611786753> **|** Como é **💸 Contributor** ganhou mais ${amount8} moons!`)
    ...
    message.channel.send(`<a:economia:580518832792272916> **|** Você recebeu suas ${amount9} moons diarias.
<:certo:580518832611786753> **|** Como é **🌹 Supreme** ganhou mais ${amount7} moons!`)
        ...
        message.channel.send(`<a:economia:580518832792272916> **|** Você recebeu suas ${amount9} moons diarias.
<:certo:580518832611786753> **|** Como é **🌻 Divine** ganhou mais ${amount6} moons!`)
            ...
            message.channel.send(`<a:economia:580518832792272916> **|** Você recebeu suas ${amount9} moons diarias.
<:certo:580518832611786753> **|** Como é **🌺 Ancion** ganhou mais ${amount5} moons!`)
                ...
                message.channel.send(`<a:economia:580518832792272916> **|** Você recebeu suas ${amount9} moons diarias.
<:certo:580518832611786753> **|** Como você é **🥀 Legend** ganhou mais ${amount4} moons!`)
                    ...
                    message.channel.send(`<a:economia:580518832792272916> **|** Você recebeu suas ${amount9} moons diarias.
<:certo:580518832611786753> **|** Como você é **🌷 Gladiator** ganhou mais ${amount3} moons!`)
                        ...
                        message.channel.send(`<a:economia:580518832792272916> **|** Você recebeu suas ${amount9} moons diarias.
<:certo:580518832611786753> **|** Como você é **🍁 Herald** ganhou mais &{amount2} moons!`)
