...
exports.run = async (client, message, args, config) => {
    ...
    if (args[0]) {
      message.reply("<:errado:580518832939204628> **|** Você precisa de especificar um item para comprar.")
        ...
        if (!message.guild.roles.find("name", '💳 Auto Claim Card')) return message.channel.send('<:errado:580518832939204628> **|** Não encontrei um cargo com o nome `💳 Auto Claim Card `, verifique o problema com a Staff.')
