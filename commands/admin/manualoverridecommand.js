...
if(message.member.roles.some(r => r.name === "Manager") || message.member.roles.some(r => r.name === "Fundador") || message.member.roles.some(r => r.name === "Moderador Plus")) { let lastdaily = await db.fetch(`lastdaily_${message.author.id}`)
